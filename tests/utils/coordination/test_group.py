import unittest
from thread_factory import ConcurrentList, Group, Outcome, Pack
...
class TestGroup(unittest.TestCase):
    ...
    def test_cleanup_on_already_cleaned_outcome(self):
    ...
    def test_cleanup_after_reset(self):
    ...
    def test_cleanup_cleanups_outcomes(self):
    ...
    def test_results_empty_after_cleanup(self):
    ...
    def test_cleanup_handles_cleaned_outcome_gracefully(self):
