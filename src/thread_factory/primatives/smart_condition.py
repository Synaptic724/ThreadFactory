...
It will allow for more advanced synchronization between runtime. This targets a specific thread ID 
and then notifies specific that threadID to wake up by calling notify(threadID).

This will be used with the dynaphore to allow for more advanced synchronization between runtime.
"""
